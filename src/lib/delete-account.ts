...
// Shared by admin-triggered deletion (admin/users/actions.ts) and
// self-service deletion (dashboard/profile/delete-account-actions.ts).
...
export async function purgeUserDataAndDeleteAccount(
